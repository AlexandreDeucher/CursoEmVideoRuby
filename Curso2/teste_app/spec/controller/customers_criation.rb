...
RSpec.describe "/customers", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      Customer.create! [{description: "alexandre", email: "alexandre@alexandrias", address: "rua alemanha"}]
      get customers_url
  ...
  describe "GET /new" do
    it "renders a successful response" do
      get new_customer_url valid_attributes
      expect(response).to be_successful
    end
  end
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Customer" do
        expect {
          post customers_url, params: { customer: valid_attributes } #[{description: "alexandre", email: "alexandre@alexandrias", address: "rua alemanha"}]
